// ============================================
// Theme CSS Variables — applied via JS for
// maximum specificity (inline styles on <html>)
// ============================================

type ThemeName =
  | 'midnight' | 'ember' | 'ocean' | 'forest'
  | 'emerald' | 'rose' | 'crimson' | 'sunset'
  | 'light' | 'nord' | 'paper' | 'mint'
...
export const THEME_VARIABLES: Record<ThemeName, Record<string, string>> = {
  ...
  ember: {
    ...
    '--primary-foreground': 'oklch(0.2 0.04 30)',
    '--secondary': 'oklch(0.22 0.02 30)',
    '--secondary-foreground': 'oklch(0.88 0.015 40)',
    ...
    '--chart-5': 'oklch(0.72 0.17 65)',
    '--sidebar': 'oklch(0.16 0.015 30)',
    '--sidebar-foreground': 'oklch(0.9 0.01 40)',
    '--sidebar-primary': 'oklch(0.7 0.2 50)',
    '--sidebar-primary-foreground': 'oklch(0.2 0.04 30)',
    '--sidebar-accent': 'oklch(0.25 0.04 45)',
  ...
  ocean: {
    ...
    '--secondary-foreground': 'oklch(0.88 0.01 200)',
    ...
    '--chart-1': 'oklch(0.7 0.18 195)',
    '--chart-2': 'oklch(0.72 0.15 200)',
    '--chart-3': 'oklch(0.6 0.15 240)',
    '--chart-4': 'oklch(0.68 0.12 210)',
    '--chart-5': 'oklch(0.7 0.14 170)',
    '--sidebar': 'oklch(0.16 0.015 200)',
    '--sidebar-foreground': 'oklch(0.9 0.01 200)',
    '--sidebar-primary': 'oklch(0.7 0.18 195)',
    '--sidebar-primary-foreground': 'oklch(0.15 0.05 200)',
    '--sidebar-accent': 'oklch(0.25 0.03 195)',
  ...
  forest: {
    ...
    '--card-foreground': 'oklch(0.93 0.01 150)',
    '--popover': 'oklch(0.18 0.015 150)',
    '--popover-foreground': 'oklch(0.93 0.01 150)',
    '--primary': 'oklch(0.65 0.22 155)',
    '--primary-foreground': 'oklch(0.15 0.05 155)',
    '--secondary': 'oklch(0.22 0.02 150)',
    '--secondary-foreground': 'oklch(0.88 0.01 150)',
    '--muted': 'oklch(0.22 0.015 150)',
    '--muted-foreground': 'oklch(0.65 0.015 150)',
    '--accent': 'oklch(0.25 0.04 155)',
    ...
    '--chart-2': 'oklch(0.7 0.2 130)',
    '--chart-3': 'oklch(0.65 0.15 195)',
    '--chart-4': 'oklch(0.72 0.18 85)',
    '--chart-5': 'oklch(0.6 0.18 150)',
    '--sidebar': 'oklch(0.16 0.015 150)',
    '--sidebar-foreground': 'oklch(0.9 0.01 150)',
    '--sidebar-primary': 'oklch(0.65 0.22 155)',
    '--sidebar-primary-foreground': 'oklch(0.15 0.05 155)',
    '--sidebar-accent': 'oklch(0.25 0.04 155)',
  ...
  emerald: {
    '--radius': '0.625rem',
    '--background': 'oklch(0.11 0.02 165)',
    '--foreground': 'oklch(0.93 0.01 165)',
    '--card': 'oklch(0.16 0.02 165)',
    ...
    '--primary-foreground': 'oklch(0.12 0.06 165)',
    '--secondary': 'oklch(0.2 0.025 165)',
    '--secondary-foreground': 'oklch(0.88 0.01 165)',
    '--muted': 'oklch(0.2 0.02 165)',
    '--muted-foreground': 'oklch(0.65 0.015 165)',
    '--accent': 'oklch(0.22 0.04 160)',
    '--accent-foreground': 'oklch(0.93 0.02 162)',
    '--destructive': 'oklch(0.65 0.25 25)',
    '--border': 'oklch(1 0 0 / 10%)',
    '--input': 'oklch(1 0 0 / 15%)',
    ...
    '--chart-5': 'oklch(0.7 0.2 310)',
    '--sidebar': 'oklch(0.14 0.02 165)',
    '--sidebar-foreground': 'oklch(0.9 0.01 165)',
    '--sidebar-primary': 'oklch(0.72 0.19 162)',
    '--sidebar-primary-foreground': 'oklch(0.12 0.06 165)',
    '--sidebar-accent': 'oklch(0.22 0.04 160)',
    '--sidebar-accent-foreground': 'oklch(0.93 0.02 162)',
    '--sidebar-border': 'oklch(1 0 0 / 10%)',
    '--sidebar-ring': 'oklch(0.72 0.19 162)',
    '--star': 'oklch(0.78 0.18 75)',
    '--heart': 'oklch(0.65 0.24 25)',
    '--success': 'oklch(0.72 0.19 162)',
    '--info': 'oklch(0.6 0.15 250)',
  },
  rose: {
    '--radius': '0.625rem',
    '--background': 'oklch(0.13 0.015 350)',
    ...
    '--accent': 'oklch(0.25 0.04 345)',
    '--accent-foreground': 'oklch(0.93 0.02 10)',
    '--destructive': 'oklch(0.65 0.25 25)',
    '--border': 'oklch(1 0 0 / 10%)',
    '--input': 'oklch(1 0 0 / 15%)',
    '--ring': 'oklch(0.65 0.25 10)',
    '--chart-1': 'oklch(0.65 0.25 10)',
    '--chart-2': 'oklch(0.7 0.2 330)',
    '--chart-3': 'oklch(0.6 0.15 280)',
    '--chart-4': 'oklch(0.72 0.18 50)',
    '--chart-5': 'oklch(0.65 0.2 170)',
    '--sidebar': 'oklch(0.16 0.015 350)',
    '--sidebar-foreground': 'oklch(0.9 0.01 350)',
    '--sidebar-primary': 'oklch(0.65 0.25 10)',
    '--sidebar-primary-foreground': 'oklch(1 0 0)',
    '--sidebar-accent': 'oklch(0.25 0.04 345)',
    '--sidebar-accent-foreground': 'oklch(0.93 0.02 10)',
    '--sidebar-border': 'oklch(1 0 0 / 10%)',
    '--sidebar-ring': 'oklch(0.65 0.25 10)',
    '--star': 'oklch(0.78 0.18 75)',
    '--heart': 'oklch(0.65 0.25 10)',
    '--success': 'oklch(0.65 0.2 145)',
    '--info': 'oklch(0.6 0.15 250)',
  },
  crimson: {
    ...
    '--card-foreground': 'oklch(0.93 0.01 20)',
    '--popover': 'oklch(0.18 0.02 20)',
    '--popover-foreground': 'oklch(0.93 0.01 20)',
    '--primary': 'oklch(0.62 0.24 20)',
    '--primary-foreground': 'oklch(1 0 0)',
    '--secondary': 'oklch(0.22 0.025 20)',
    '--secondary-foreground': 'oklch(0.88 0.01 20)',
    '--muted': 'oklch(0.22 0.02 20)',
    '--muted-foreground': 'oklch(0.65 0.015 20)',
    '--accent': 'oklch(0.25 0.04 18)',
    '--accent-foreground': 'oklch(0.95 0.02 20)',
    '--destructive': 'oklch(0.65 0.25 25)',
    '--border': 'oklch(1 0 0 / 10%)',
    '--input': 'oklch(1 0 0 / 15%)',
    '--ring': 'oklch(0.62 0.24 20)',
    '--chart-1': 'oklch(0.62 0.24 20)',
    '--chart-2': 'oklch(0.7 0.2 45)',
    '--chart-3': 'oklch(0.55 0.18 350)',
    '--chart-4': 'oklch(0.72 0.15 70)',
    '--chart-5': 'oklch(0.6 0.2 310)',
    '--sidebar': 'oklch(0.16 0.02 20)',
    '--sidebar-foreground': 'oklch(0.9 0.01 20)',
    '--sidebar-primary': 'oklch(0.62 0.24 20)',
    '--sidebar-primary-foreground': 'oklch(1 0 0)',
    '--sidebar-accent': 'oklch(0.25 0.04 18)',
    '--sidebar-accent-foreground': 'oklch(0.95 0.02 20)',
    '--sidebar-border': 'oklch(1 0 0 / 10%)',
    '--sidebar-ring': 'oklch(0.62 0.24 20)',
    '--star': 'oklch(0.78 0.18 75)',
  ...
  sunset: {
    ...
    '--popover': 'oklch(0.19 0.015 55)',
    '--popover-foreground': 'oklch(0.93 0.01 60)',
    '--primary': 'oklch(0.75 0.15 55)',
    '--primary-foreground': 'oklch(0.18 0.06 55)',
    '--secondary': 'oklch(0.23 0.02 55)',
    '--secondary-foreground': 'oklch(0.88 0.01 60)',
    '--muted': 'oklch(0.23 0.015 55)',
    '--muted-foreground': 'oklch(0.65 0.015 60)',
    '--accent': 'oklch(0.27 0.04 50)',
    '--accent-foreground': 'oklch(0.93 0.02 55)',
    '--destructive': 'oklch(0.65 0.25 25)',
    '--border': 'oklch(1 0 0 / 10%)',
    '--input': 'oklch(1 0 0 / 15%)',
    '--ring': 'oklch(0.75 0.15 55)',
    '--chart-1': 'oklch(0.75 0.15 55)',
    '--chart-2': 'oklch(0.7 0.18 30)',
    '--chart-3': 'oklch(0.72 0.12 20)',
    '--chart-4': 'oklch(0.68 0.2 80)',
    ...
    '--sidebar-primary-foreground': 'oklch(0.18 0.06 55)',
    '--sidebar-accent': 'oklch(0.27 0.04 50)',
    '--sidebar-accent-foreground': 'oklch(0.93 0.02 55)',
    '--sidebar-border': 'oklch(1 0 0 / 10%)',
  ...
  light: {
    ...
    '--star': 'oklch(0.75 0.18 75)',
    '--heart': 'oklch(0.6 0.24 25)',
  ...
  nord: {
    ...
    '--chart-2': 'oklch(0.55 0.12 195)',
    '--chart-3': 'oklch(0.5 0.15 290)',
    '--chart-4': 'oklch(0.65 0.18 55)',
    ...
    '--star': 'oklch(0.75 0.16 75)',
    '--heart': 'oklch(0.58 0.22 25)',
  ...
  paper: {
    ...
    '--chart-2': 'oklch(0.55 0.1 30)',
    '--chart-3': 'oklch(0.5 0.15 150)',
    '--chart-4': 'oklch(0.6 0.15 75)',
    ...
    '--sidebar-accent': 'oklch(0.93 0.01 65)',
  ...
  mint: {
    ...
    '--popover-foreground': 'oklch(0.18 0.02 160)',
    ...
    '--muted': 'oklch(0.94 0.008 160)',
    '--muted-foreground': 'oklch(0.5 0.02 160)',
    '--accent': 'oklch(0.92 0.015 155)',
    ...
    '--chart-3': 'oklch(0.48 0.12 250)',
    '--chart-4': 'oklch(0.6 0.15 80)',
    '--chart-5': 'oklch(0.55 0.18 30)',
    '--sidebar': 'oklch(0.96 0.006 160)',
    '--sidebar-foreground': 'oklch(0.18 0.02 160)',
    '--sidebar-primary': 'oklch(0.52 0.15 160)',
    '--sidebar-primary-foreground': 'oklch(0.98 0.005 160)',
    '--sidebar-accent': 'oklch(0.92 0.015 155)',
    '--sidebar-accent-foreground': 'oklch(0.28 0.05 160)',
    '--sidebar-border': 'oklch(0.9 0.01 160)',
    '--sidebar-ring': 'oklch(0.52 0.15 160)',
    '--star': 'oklch(0.75 0.18 75)',
    '--heart': 'oklch(0.6 0.24 25)',
    '--success': 'oklch(0.52 0.15 160)',
    '--info': 'oklch(0.55 0.12 250)',
  },
}

/** Apply theme CSS variables directly to <html> element via inline styles.
 *  This guarantees the highest specificity — always wins over any CSS rule. */
export function applyThemeCSSVars(theme: string): void {
  const vars = THEME_VARIABLES[theme as ThemeName]
  if (!vars) return
...
/** Clear all theme CSS variables from <html> inline styles,
 *  falling back to the CSS file's :root defaults. */
export function clearThemeCSSVars(): void {
  const allKeys = new Set<string>()
  for (const vars of Object.values(THEME_VARIABLES)) {
